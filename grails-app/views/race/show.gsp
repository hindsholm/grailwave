	...
	<body>
		...
		<div id="show-race" class="content scaffold-show" role="main">
			...
			<ol class="property-list race">
				...
				<g:if test="${raceInstance?.series}">
				<li class="fieldcontain">
					<span id="series-label" class="property-label"><g:message code="race.series.label" default="Series" /></span>
					
						<span class="property-value" aria-labelledby="series-label"><g:link controller="series" action="show" id="${raceInstance?.series?.id}">${raceInstance?.series?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${raceInstance?.startTime}">
				<li class="fieldcontain">
					<span id="startTime-label" class="property-label"><g:message code="race.startTime.label" default="Start Time" /></span>
					
						<span class="property-value" aria-labelledby="startTime-label"><g:formatDate date="${raceInstance?.startTime}" /></span>
